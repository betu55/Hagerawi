...
class PostEvents extends StatelessWidget {
  ...
  static const String routeName = "/deleteEvent";
          ...
          child: BlocBuilder<AdminEventBloc, AdminEventState>(
            builder: (ctx, state) {
              ...
              if (state is EventsUploaded) {
                return Center(
                  child: Text("Deleted event successfully"),
                );
              ...
              return Center(
                child: Column(
                  ...
                  children: [
                    theItems(id, "ID of event to delete..."),
                    SizedBox(height: 10),
                    Container(
                      decoration: BoxDecoration(
                      ...
                      child: ElevatedButton(
                        ...
                        onPressed: () {
                          ...
                          adminBloc.add(DeleteEventsEvent(id.toString()));
                        },
                        child: Text("Delete"),
                      ),
                    ),
